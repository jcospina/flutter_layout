...
void main() => runApp(LayoutTutorialApp());
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: <Widget>[
        ...
        // and 41 - a jump would otherwise occur because those values have
        // different widths
        SizedBox(
          width: 18,
...
class LayoutTutorialApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget titleSection = Container(
        ...
        child: Row(
            children: <Widget>[
              // Putting Column inside Expanded widget stretches the column to
